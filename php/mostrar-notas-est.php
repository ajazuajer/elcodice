...
echo "	<table>
	<br/><h2>Materia:
            ...
            <tr>
                <td>
                    <input type='text' name='nota1' size=10 value=$nota1 />
                </td>
                <td>
                    <input type='text' name='nota2' size=10 value=$nota2 />
                </td>
                <td>
                    <input type='text' name='nota3' size=10 value=$nota3 />
                </td>
                <td>
                    <input type='text' name='nota4' size=10 value=$nota4 />
                </td>
                <td>
                    <input type='text' name='nota5' size=10 value=$nota5 />
                </td>
                <td>
                    <input type='text' name='nota6' size=10 value=$nota6 />
                </td>
                <td>
                    <input type='text' name='nota7' size=10 value=$nota7 />
                </td>
                <td>
                    <input type='text' name='nota8' size=10 value=$nota8 />
                </td>
                <td>
                    <input type='text' name='nota9' size=10 value=$nota9 />
                </td>
                <td>
                    <input type='text' name='suma' size=10 value=$suma/>
                </td>
		        <td>
                    <input type='text' name='porc' size=10 value=$porcent/>
                </td>
            </tr>";}
 echo "              </table>
<br/><br/></form>
Imprimir:<br/>
<a href='/php/imprimirestud.php?ced=$ced&per=$per'>Notas</a><br/>
<br/><br/><br/>
